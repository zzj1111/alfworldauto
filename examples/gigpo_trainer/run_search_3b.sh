...
export TMPDIR=/dev/shm/ztmp
export RAY_TMPDIR=/dev/shm/zray
...
/mnt/data1/zha00175/miniconda/envs/verl/bin/python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='gigpo_3b_searchr1' \
    trainer.default_local_dir=/mnt/data1/zha00175/ckpts_search_3b \
    trainer.resume_mode=auto \
    +ray_init._temp_dir=/dev/shm/zray \
