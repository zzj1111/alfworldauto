...
export GIGPO_SKILL_PATH=/mnt/data1/zha00175/searchR1_data/search_skills_v0.json
export GIGPO_SKILL_MODE=full
export GIGPO_SKILL_P=1.0
export GIGPO_SKILL_DEBUG=1
export WANDB_ENTITY=mhong-university-of-minnesota
export TMPDIR=/dev/shm/ztmp_skill
export RAY_TMPDIR=/dev/shm/zray_skill
...
/mnt/data1/zha00175/miniconda/envs/verl/bin/python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/mnt/data1/zha00175/skillzero-env/models/Qwen2.5-3B-Instruct \
    ...
    trainer.experiment_name='gigpo_3b_searchr1_skill' \
    trainer.default_local_dir=/mnt/data1/zha00175/ckpts_search_3b_skill \
    trainer.resume_mode=auto \
    +ray_init._temp_dir=/dev/shm/zray_skill \
