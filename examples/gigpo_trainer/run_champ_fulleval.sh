...
/mnt/data1/zha00175/miniconda/envs/verl/bin/python3 -m verl.trainer.main_ppo \
    ...
    data.val_files=/home/zha00175/data/searchR1_processed_direct/test.parquet \
    ...
    actor_rollout_ref.model.path=/mnt/data1/zha00175/ckpts_search_3b_iter2/global_step_600/actor/huggingface \
