...
_SIGNAL_MEANINGS = (
    ...
    "- failure_trajectories = real bare (no-scaffold) rollouts on train, with computed "
    "signals per step (opens/takes/held_an_object). This is the model's own behavior.\n"
...
def assemble_triage_observation(current_scaffold, eval_traj, decision_history, step,
                                per_task=None, per_task_n=None, cycle=None,
                                n_cycles=None, floor_cycles=None):
    ...
    still empty, is what makes "not yet" a claim with a cost attached. Measured here: the one arm
    that ran with this pre-check declined 17 of 20 cycles and produced no scaffold at all.
    """
